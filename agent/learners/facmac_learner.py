...
from agent.modules.critics.facmac import FACMACCritic
import torch as th
from torch.optim import RMSprop, Adam
from agent.modules.mixers.vdn import VDNMixer
from agent.modules.mixers.qmix import QMixer
from agent.modules.mixers.qmix_ablations import VDNState, QMixerNonmonotonic
...
class FACMACLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        self.critic.init_hidden(batch.batch_size)
        for t in range(batch.max_seq_length):
            agent_outs = self.mac.forward(batch, t=t, select_actions=True).view(batch.batch_size,
                                                                                           self.n_agents,
                                                                                           self.n_actions)
    ...
    def save_models(self, path):
        ...
        th.save(self.critic_optimiser.state_dict(), "{}/opt_critic.th".format(path))
