...
import agent.DCDRL.utils as utils
from agent.DCDRL.nets import Actor, Critic
from agent.DCDRL.noises import OUNoise, AdaptiveParamNoiseSpec, distance_metric
from agent.DCDRL.replay_buffer import ReplayBufferM
from agent.DCDRL.utils import str2bool
...
class Agent(object):
    ...
    def save_model(self, env_name):
        ...
        #     os.makedirs('models/')
        actor_path = "{}/policy.th".format(env_name)
        critic_path = "{}/critic_dc.th".format(env_name)
        torch.save(self.actor.state_dict(), actor_path)
        torch.save(self.critic.state_dict(), critic_path)

    def load_model(self, model_path):
        self.actor.load_state_dict(torch.load("{}/policy.th".format(model_path)))
        self.critic.load_state_dict(torch.load("{}/critic_dc.th".format(model_path)))
